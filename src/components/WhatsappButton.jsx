...
const WhatsAppButton = () => {
  ...
  const whatsappHref = `https://api.whatsapp.com/send/?phone=5521999135401&text=Ol%C3%A1%21+Vim+pelo+website+e+desejo+tirar+d%C3%BAvidas.&type=phone_number&app_absent=0`;
