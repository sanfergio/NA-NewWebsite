...
const categorias = [
    {
        ...
        icon: "fa-fire",
        title: "Termogênicos",
        img: "https://images.newandrews.com.br/image-andrews/cards/Termogenicos.png",
    },
    {
        href: "/categorias?categoria=aminoacidos",
        icon: "fa-flask",
        title: "Aminoácidos",
        img: "https://images.newandrews.com.br/image-andrews/cards/Aminoacidos.png",
    },
    {
        href: "/categorias?categoria=xaropes",
        icon: "fa-coffee",
        title: "Xaropes <br /> e Chás",
        img: "https://images.newandrews.com.br/image-andrews/cards/Xaropes.png",
    },
    {
        href: "/categorias?categoria=masculine",
        icon: "fa-mars-stroke",
        title: "Produtos <br /> Masculinos",
        img: "https://images.newandrews.com.br/image-andrews/cards/Masculinos.png",
    },
    {
        href: "/categorias?categoria=vitamins",
        icon: "fa-capsules",
        title: "Vitaminas",
        img: "https://images.newandrews.com.br/image-andrews/cards/Vitaminas.png",
    },
    {
        href: "/categorias?categoria=pre-workout",
        icon: "fa-bolt",
        title: "Pré-Treinos",
        img: "https://images.newandrews.com.br/image-andrews/cards/Pre-Treinos.png",
    },
    {
        href: "/categorias?categoria=oils",
        icon: "fa-tint",
        title: "Óleos",
        img: "https://images.newandrews.com.br/image-andrews/cards/Oleos.png",
    },
    {
        href: "/categorias?categoria=female",
        icon: "fa-venus",
        title: "Produtos <br /> Femininos",
        img: "https://images.newandrews.com.br/image-andrews/cards/Femininos.png",
    },
];
