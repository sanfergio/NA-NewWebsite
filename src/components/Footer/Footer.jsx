        ...
        <div className={styles.footerGrid}>
          ...
          <div>
            ...
            <div className={styles.footerLinks}>
              ...
              <a target="_blank" href="https://api.whatsapp.com/send/?phone=5521999135401&text=Ol%C3%A1%21+Vim+pelo+website+e+desejo+tirar+d%C3%BAvidas.&type=phone_number&app_absent=0">Entre em Contato</a>
          ...
          <div>
            ...
            <div className={styles.footerContact}>
              <p><Phone size={18} color="#000000" /> (21) 99913-5401</p>
          ...
          <div>
            <div className={styles.footerSocial}>
              ...
              <div className={styles.footerIcons}>
                ...
                <a target="_blank" href="https://api.whatsapp.com/send/?phone=5521999135401&text=Ol%C3%A1%21+Vim+pelo+website+e+desejo+tirar+d%C3%BAvidas.&type=phone_number&app_absent=0" aria-label="WhatsApp"><Phone size={20} /></a>
